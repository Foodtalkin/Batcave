<?php
    ...
    $url = "http://foodtalkplus.com/forms/1/API/save.api.php";
    //  Initiate curl
    $ch = curl_init();
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <li>
                                ...
                                <li>
                                    <a class="active" href="app_data.php">App Data</a>
                                </li>
                                <li>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Food Talk Plus data for 1-10 forms
                        </div>
                        <!-- /.panel-heading -->
