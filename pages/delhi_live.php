                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           Delhi Live Form -- Form 1
                           <a href="download3.php" target="_blank" class="btn csv ">Download csv</a>
                        </div>
                        <!-- /.panel-heading -->
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody class="cont">
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $key['c_desg']; ?></td>
                                            <td><?php echo $key['stall']; ?></td>
                                            ...
                                            <td>
                                                    ...
                                                    elseif($key['status'] == 0)
                                                        echo '<span class="btn btn-xs btn-danger dueButton" id="dl_'. $key['id'] .'">due</span>';
