                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a class="active" href="fb_invites.php">FB Invits <span class="aler"><?php 
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href=<?php echo "https://www.facebook.com/search/str/".$key['f_mail']."/keywords_top"; ?> target="_Blank" >
                                                <?php echo $key['f_mail']; ?></a>
                                             </td>
                                            <td><?php echo $key['f_gender']; ?></td>
                                            <td class="hidden-phone-portrait "><?php 
                                                if($key['f_status'] == 1) 
                                                    echo '<span class="btn btn-xs btn-success">done</span>';
                                                elseif($key['f_status'] == 0)
                                                    echo '<span class="btn btn-xs btn-danger dueButton" id="inv_'. $key['f_id'] .'">due</span>';
                                                ?></td>
