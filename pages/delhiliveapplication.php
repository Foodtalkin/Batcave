<?php
    ...
    $data= getafter('contact_form', $con2, 'id');
                                    ...
                                    <tbody class="cont">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                    ...
                                                    elseif($key['status'] == 0)
                                                        echo '<span class="btn btn-xs btn-danger dueButton" id="cdl_'. $key['id'] .'">due</span>';
