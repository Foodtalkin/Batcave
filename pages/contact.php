                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a  class="active" href="contact.php">Contact <span class="aler"><?php 
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Phone</th>
                                            <th>Site</th>
                                            <th class="msg" width="400px">Message</th>
                                            <th>Status</th>
                                            <th>Time</th>
                                        </tr>
                                    </thead>
                                    <tbody class="cont">
                                        ...
                                        ?>
                                         <tr>
                                            ...
                                            <td><a href="http://<?php echo $key['web']; ?>" target="_Blank"><?php echo $key['site']; ?></a></td>
                                            <td class="msg" width="400px"><?php echo $key['message']; ?></td>
                                            <td>
                                                <?php 
                                                if($key['status'] == 1) 
                                                    echo '<span class="btn btn-xs btn-success">done</span>';
                                                elseif($key['status'] == 0)
                                                    echo '<span class="btn btn-xs btn-danger dueButton" id="contact_'. $key['id'] .'">due</span>';
                                                ?>
                                            </td>
