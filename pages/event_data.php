<?php
    ...
    $data= get('collected_data', $con, 'id');
    $counter = 1;
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <form action="downloadevent.php" method="Post" id="frm">
                            <div class="col-lg-8">
                                <div class="form-group">
                                    <label for="category">Event</label>
                                    <select name="event1" class="form-control" id="event1">
                                        <option value="">Select event</option>
                                        <?php 
                                           $cat= getfield('collected_data', $con, 'event1'); 
                                           foreach ($cat as $cat) {
                                             echo "<option value='".$cat['event1']."'>".$cat['event1']."</option>";  
                                           }
                                         ?>
                                    </select>
                                </div>
                            ...
                            <div class="col-lg-4 col-sm-4">
                                <button type="submit" class="btn btn-success submit pull-right">Download</button>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Events data
                            <a href="download4.php" target="_blank" class="btn csv ">Download csv</a>
                        </div>
                        <!-- /.panel-heading -->
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $key['event1']; ?></td>
                                            <td><?php echo $key['city']; ?></td>
                                            <td><?php echo $key['gender']; ?></td>
                                            <td><?php echo $key['meta1']; ?></td>
                                            <td><?php echo $key['meta2']; ?></td>
                                            <td><?php echo $key['meta3']; ?></td>
                                            <td><?php echo $key['meta4']; ?></td>
                                            <td><?php echo $key['meta5']; ?></td>
