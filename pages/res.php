                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $key['home_d']; ?></td>
                                            <td><?php echo $key['nveg']; ?></td>
                                            <td><?php echo $key['dinein']; ?></td>
                                            <td><?php echo $key['outdoor']; ?></td>
                                            <td><?php echo $key['ac']; ?></td>
                                            <td><?php echo $key['bar']; ?></td>
                                            <td><?php echo $key['microbrewery']; ?></td>
                                            <td><?php echo $key['sheesha']; ?></td>
                                            <td><?php echo $key['wifi']; ?></td>
                                            <td><?php echo $key['l_music']; ?></td>
